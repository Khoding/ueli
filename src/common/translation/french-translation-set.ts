...
export const frenchTranslationSet: TranslationSet = {
    trayIconShow: 'Afficher',
    trayIconSettings: 'Paramètres',
    trayIconQuit: 'Quitter',

    userConfirmationProceed: 'Procéder?',

    noSearchResultsFoundDescription: '',
    noSearchResultsFoundTitle: 'Aucun résultats trouvés',

    refreshingIndexesPending: 'Rafraichissement des indices',

    ueliCommandClearCaches: 'Vider le cache',
    ueliCommandClearCachesDescription: 'Vider tous les caches de tous les plugins',
    ueliCommandEditSettingsFile: 'Modifier le fichier de paramètres',
    ueliCommandEditSettingsFileDescription: 'Modifier le fichier de paramètres avec votre editeur de texte par défaut',
    ueliCommandExit: 'Quitter',
    ueliCommandExitDescription: 'Quitter ueli',
    ueliCommandOpenSettings: 'Paramètres',
    ueliCommandOpenSettingsDescription: 'Modifier les paramètres',
    ueliCommandRefreshIndexes: 'Rafraîchir les indices',
    ueliCommandRefreshIndexesDescription: 'Rafraîchit tous les indices de tous les plugins',
    ueliCommandReload: 'Recharger',
    ueliCommandReloadDescription: 'Recharger ueli',

    generalErrorTitle: "Une erreur s'est produite",
    generalErrorDescription: 'Consulter les journaux pour plus de détails',

    successfullyRefreshedIndexes: 'Indices rafraichis avec succès',
    successfullyClearedCaches: 'Caches vidés avec succès',
    successfullyUpdatedconfig: 'Paramètres modifiés avec succès',
    successfullyClearedExecutionLog: "Journaux d'exécutions effacés avec succès",

    commandlineSearchResultDescription: 'Exécution de {{command}}',

    noFavoritesFoundDescription: "Vos logs d'executions sont vides",
    noFavoritesFoundTitle: 'Pas de favoris trouvés',

    // settings
    settings: 'Paramètres',

    generalSettingsMenuSection: 'Paramètres généraux',
    pluginSettingsMenuSection: 'Plugins',

    generalSettings: 'Paramètres généraux',
    generalSettingsLanguage: 'Langages',
    generalSettingsLogExecution: 'Jou',
